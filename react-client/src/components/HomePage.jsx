...
const HomePage = (props) => (
  ...
  Save your favorite recipes, find out nutritional value and more.
    ...
    <div className="row featurette">
          ...
          <Link to={'breakfast'}  >
          <h2 className="featurette-heading">Breakfast </h2>
        </Link>
          ...
          <div className="col-md-5">
            <img className="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="https://host-service.s3-us-west-1.amazonaws.com/breakfast.jpg" data-holder-rendered="true"/>
          </div>
        </div>
        ...
        <div className="row featurette">
          <div className="col-md-7">
          <Link to={'lunch'}  >
          <h2 className="featurette-heading">Lunch </h2>
        </Link>
          ...
          <div className="col-md-5">
            <img className="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="https://host-service.s3-us-west-1.amazonaws.com/lunch.jpg" data-holder-rendered="true"/>
          </div>
        </div>
        ...
        <div className="row featurette">
          <div className="col-md-7">
          <Link to={'dinner'}  >
          <h2 className="featurette-heading">Dinner </h2>
        </Link>
          ...
          <div className="col-md-5">
            <img className="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="https://host-service.s3-us-west-1.amazonaws.com/dinner.jpg" data-holder-rendered="true"/>
          </div>
        </div>
        ...
        <div className="row featurette">
          ...
          <div className="col-md-5">
            <img className="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="https://host-service.s3-us-west-1.amazonaws.com/snacks.png" data-holder-rendered="true"/>
          </div>
        </div>
